...
<?php include 'headerbottom.php'; ?>	
		<section id="conditions">
			...
			<p>Manual Therapy helps the body heal itself and thus treats many conditions. Below is a selected list of conditions treatable by Manual Therapy. If you do not see you condition contact us directly to determine if we can help you.</p>
